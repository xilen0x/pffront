    ...
    return (
        <>
            <div className="row">
                ...
                <div className="col-md-6 mx-auto my-5 text-justify">
                    <h1>BIENVENIDO ESTE ES EL HOME DEL ADMINISTRADOR!</h1>
                    <h2>Elije que quieres hacer!!!</h2>
                    <p>Por favor elige que deseas hacer en la barra lateral y serás redireccionado:</p>
