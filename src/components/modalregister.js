...
import modallogin from '../styles/modalregister.css'

const ModalRegister = props => {
  return (
    <>
      <div className="modal fade" id="ModalRegister" role="dialog" aria-labelledby="ModalRegisterTitle" aria-hidden="true">
        <div className="modal-dialog modal-dialog-centered" role="document">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title" id="ModalRegisterTitle">Ingrese los siguientes datos para su registro:</h5>
